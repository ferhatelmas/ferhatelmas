...
- [cloudflare/workers-sdk](https://github.com/cloudflare/workers-sdk) ([wrangler@4.53.0](https://github.com/cloudflare/workers-sdk/releases/tag/wrangler%404.53.0), 2 days ago) - ⛅️ Home to Wrangler, the CLI for Cloudflare Workers®
- [golangci/golangci-lint](https://github.com/golangci/golangci-lint) ([v2.7.1](https://github.com/golangci/golangci-lint/releases/tag/v2.7.1), 2 days ago) - Fast linters runner for Go
...
- [*: enable errcheck linter](https://github.com/go-git/go-git/pull/1786) on [go-git/go-git](https://github.com/go-git/go-git) (1 day ago)
- [Enable gocritic and nolintlint linters](https://github.com/go-git/go-git/pull/1781) on [go-git/go-git](https://github.com/go-git/go-git) (2 days ago)
- [git: prevent panic when tree entry has zero hash](https://github.com/go-git/go-git/pull/1778) on [go-git/go-git](https://github.com/go-git/go-git) (2 days ago)
- [*: enable revive linter](https://github.com/go-git/go-git/pull/1771) on [go-git/go-git](https://github.com/go-git/go-git) (4 days ago)
- [refactor(lint): add new linters and fix their issues](https://github.com/apache/answer/pull/1445) on [apache/answer](https://github.com/apache/answer) (5 days ago)
