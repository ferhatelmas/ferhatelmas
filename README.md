...
- [cloudflare/workers-sdk](https://github.com/cloudflare/workers-sdk) ([wrangler@4.60.0](https://github.com/cloudflare/workers-sdk/releases/tag/wrangler%404.60.0), 4 days ago) - ⛅️ Home to Wrangler, the CLI for Cloudflare Workers®
- [cli/cli](https://github.com/cli/cli) ([v2.86.0](https://github.com/cli/cli/releases/tag/v2.86.0), 5 days ago) - GitHub’s official command line tool
- [cloudflare/terraform-provider-cloudflare](https://github.com/cloudflare/terraform-provider-cloudflare) ([v5.16.0](https://github.com/cloudflare/terraform-provider-cloudflare/releases/tag/v5.16.0), 5 days ago) - Cloudflare Terraform Provider
...
- [refactor(ci): use staticcheck from golangci-lint](https://github.com/apache/iceberg-go/pull/700) on [apache/iceberg-go](https://github.com/apache/iceberg-go) (1 day ago)
- [fix(table): handle race for key map getter](https://github.com/apache/iceberg-go/pull/699) on [apache/iceberg-go](https://github.com/apache/iceberg-go) (1 day ago)
- [feat(ci): add lint action](https://github.com/apache/answer/pull/1478) on [apache/answer](https://github.com/apache/answer) (3 days ago)
- [fix(table): find min seq correctly from manifest list](https://github.com/apache/iceberg-go/pull/693) on [apache/iceberg-go](https://github.com/apache/iceberg-go) (4 days ago)
- [refactor(iceberg): replace max util with std equivalent](https://github.com/apache/iceberg-go/pull/690) on [apache/iceberg-go](https://github.com/apache/iceberg-go) (5 days ago)
