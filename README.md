...
- [samber/slog-common](https://github.com/samber/slog-common) ([v0.18.0](https://github.com/samber/slog-common/releases/tag/v0.18.0), 4 days ago) - Common toolchain for slog
- [imroc/req](https://github.com/imroc/req) ([v3.49.0](https://github.com/imroc/req/releases/tag/v3.49.0), 5 days ago) - Simple Go HTTP client with Black Magic
