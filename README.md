...
- [supabase/supabase-js](https://github.com/supabase/supabase-js) ([v2.108.2-canary.3](https://github.com/supabase/supabase-js/releases/tag/v2.108.2-canary.3), today) - An isomorphic Javascript client for Supabase. Query your Supabase database, subscribe to realtime events, upload and download files, browse typescript examples, invoke postgres functions via rpc, invoke supabase edge functions, query pgvector.
- [cli/cli](https://github.com/cli/cli) ([v2.94.0](https://github.com/cli/cli/releases/tag/v2.94.0), 1 day ago) - GitHub’s official command line tool
- [supabase/storage](https://github.com/supabase/storage) ([v1.60.15](https://github.com/supabase/storage/releases/tag/v1.60.15), 2 days ago) - S3 compatible object storage service that stores metadata in Postgres
- [supabase/iceberg-js](https://github.com/supabase/iceberg-js) ([iceberg-js-v1.0.0](https://github.com/supabase/iceberg-js/releases/tag/iceberg-js-v1.0.0), 3 days ago) - A small, framework-agnostic JavaScript/TypeScript client for the Apache Iceberg REST Catalog.
...
- [chore: drop pgboss-v10 migrate admin endpoint](https://github.com/supabase/storage/pull/1146) on [supabase/storage](https://github.com/supabase/storage) (today)
- [fix: harden pg connection and admin timeouts](https://github.com/supabase/storage/pull/1145) on [supabase/storage](https://github.com/supabase/storage) (1 day ago)
- [fix: error listeners for pools](https://github.com/supabase/storage/pull/1144) on [supabase/storage](https://github.com/supabase/storage) (2 days ago)
