...
- [supabase/supabase-js](https://github.com/supabase/supabase-js) ([v2.108.1](https://github.com/supabase/supabase-js/releases/tag/v2.108.1), 2 days ago) - An isomorphic Javascript client for Supabase. Query your Supabase database, subscribe to realtime events, upload and download files, browse typescript examples, invoke postgres functions via rpc, invoke supabase edge functions, query pgvector.
...
- [fix: drive ssl for mt through conn string](https://github.com/supabase/storage/pull/1143) on [supabase/storage](https://github.com/supabase/storage) (2 days ago)
