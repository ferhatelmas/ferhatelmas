...
- [supabase/storage](https://github.com/supabase/storage) ([v1.36.4](https://github.com/supabase/storage/releases/tag/v1.36.4), today) - S3 compatible object storage service that stores metadata in Postgres
...
- [fix: distinct xattr for etag in linux file backend](https://github.com/supabase/storage/pull/842) on [supabase/storage](https://github.com/supabase/storage) (today)
