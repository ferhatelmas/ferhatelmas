...
- [supabase/storage](https://github.com/supabase/storage) ([v1.60.29](https://github.com/supabase/storage/releases/tag/v1.60.29), today) - S3 compatible object storage service that stores metadata in Postgres
...
- [tus/tusd](https://github.com/tus/tusd) ([v2.10.0](https://github.com/tus/tusd/releases/tag/v2.10.0), 6 days ago) - Reference server implementation in Go of tus: the open protocol for resumable file uploads

#### 🔨 Latest Pull Requests I published

- [fix: improve performance of log redaction](https://github.com/supabase/storage/pull/1172) on [supabase/storage](https://github.com/supabase/storage) (today)
...
- [THUDM/slime](https://github.com/THUDM/slime) - slime is an LLM post-training framework for RL Scaling. (3 days ago)
- [KellerKev/duckicelake](https://github.com/KellerKev/duckicelake) - Iceberg v3 REST Catalog proxy on top of DuckLake (4 days ago)
- [zeke/faster-chrome-devtools-skill](https://github.com/zeke/faster-chrome-devtools-skill) - Agent skill that makes Chrome DevTools MCP faster (4 days ago)
