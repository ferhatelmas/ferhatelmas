...
- [imroc/req](https://github.com/imroc/req) ([v3.46.0](https://github.com/imroc/req/releases/tag/v3.46.0), 3 days ago) - Simple Go HTTP client with Black Magic
- [minio/minio](https://github.com/minio/minio) ([RELEASE.2024-09-09T16-59-28Z](https://github.com/minio/minio/releases/tag/RELEASE.2024-09-09T16-59-28Z), 4 days ago) - MinIO is a high-performance, S3 compatible object store, open sourced under GNU AGPLv3 license.
