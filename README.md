...
- [supabase/storage](https://github.com/supabase/storage) ([v1.60.8](https://github.com/supabase/storage/releases/tag/v1.60.8), 3 days ago) - S3 compatible object storage service that stores metadata in Postgres
- [supabase/supabase-js](https://github.com/supabase/supabase-js) ([v2.108.0-canary.0](https://github.com/supabase/supabase-js/releases/tag/v2.108.0-canary.0), 4 days ago) - An isomorphic Javascript client for Supabase. Query your Supabase database, subscribe to realtime events, upload and download files, browse typescript examples, invoke postgres functions via rpc, invoke supabase edge functions, query pgvector.
...
- [fix: provide unique metric identity for workers](https://github.com/supabase/storage/pull/1134) on [supabase/storage](https://github.com/supabase/storage) (4 days ago)
- [fix: add acceptance matrix for vectors](https://github.com/supabase/storage/pull/1132) on [supabase/storage](https://github.com/supabase/storage) (5 days ago)
