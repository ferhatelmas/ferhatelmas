...
- [imroc/req](https://github.com/imroc/req) ([v3.48.0](https://github.com/imroc/req/releases/tag/v3.48.0), 3 days ago) - Simple Go HTTP client with Black Magic
- [minio/minio-go](https://github.com/minio/minio-go) ([v7.0.78](https://github.com/minio/minio-go/releases/tag/v7.0.78), 5 days ago) - MinIO Go client SDK for S3 compatible object storage
