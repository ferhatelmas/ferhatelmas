...
- [minio/minio-go](https://github.com/minio/minio-go) ([v7.0.81](https://github.com/minio/minio-go/releases/tag/v7.0.81), 2 days ago) - MinIO Go client SDK for S3 compatible object storage
...
- [dxos/dxos](https://github.com/dxos/dxos) - TypeScript implementation of the DXOS protocols, SDK, toolchain and Composer. (1 month ago)
