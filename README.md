...
- [supabase/storage](https://github.com/supabase/storage) ([v1.48.27](https://github.com/supabase/storage/releases/tag/v1.48.27), 1 day ago) - S3 compatible object storage service that stores metadata in Postgres
...
- [supabase/supabase-js](https://github.com/supabase/supabase-js) ([v2.102.1](https://github.com/supabase/supabase-js/releases/tag/v2.102.1), 1 day ago) - An isomorphic Javascript client for Supabase. Query your Supabase database, subscribe to realtime events, upload and download files, browse typescript examples, invoke postgres functions via rpc, invoke supabase edge functions, query pgvector.
...
- [chore: use sample env files for tests](https://github.com/supabase/storage/pull/981) on [supabase/storage](https://github.com/supabase/storage) (2 days ago)
- [fix: allow empty json body for delete/empty bucket](https://github.com/supabase/storage/pull/974) on [supabase/storage](https://github.com/supabase/storage) (2 days ago)
