...
- [supabase/supabase-js](https://github.com/supabase/supabase-js) ([v2.104.0](https://github.com/supabase/supabase-js/releases/tag/v2.104.0), today) - An isomorphic Javascript client for Supabase. Query your Supabase database, subscribe to realtime events, upload and download files, browse typescript examples, invoke postgres functions via rpc, invoke supabase edge functions, query pgvector.
- [supabase/storage](https://github.com/supabase/storage) ([v1.54.0](https://github.com/supabase/storage/releases/tag/v1.54.0), today) - S3 compatible object storage service that stores metadata in Postgres
