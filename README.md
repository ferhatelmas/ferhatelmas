...
- [supabase/storage](https://github.com/supabase/storage) ([v1.67.5](https://github.com/supabase/storage/releases/tag/v1.67.5), today) - S3 compatible object storage service that stores metadata in Postgres
- [apache/answer](https://github.com/apache/answer) ([v2.0.2-RC3](https://github.com/apache/answer/releases/tag/v2.0.2-RC3), today) - A Q&amp;A platform software for teams at any scales. Whether it&#39;s a community forum, help center, or knowledge management platform, you can always count on Apache Answer.
- [platformatic/platformatic](https://github.com/platformatic/platformatic) ([v3.63.0-alpha.2](https://github.com/platformatic/platformatic/releases/tag/v3.63.0-alpha.2), today) - Platformatic Open Source monorepo!
...
- [fix: bump watt to latest and align config to control via env](https://github.com/supabase/storage/pull/1243) on [supabase/storage](https://github.com/supabase/storage) (today)
- [fix: add transport-neutral database contracts](https://github.com/supabase/storage/pull/1242) on [supabase/storage](https://github.com/supabase/storage) (today)
