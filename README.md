...
- [imroc/req](https://github.com/imroc/req) ([v3.46.1](https://github.com/imroc/req/releases/tag/v3.46.1), 2 days ago) - Simple Go HTTP client with Black Magic
- [cloudflare/terraform-provider-cloudflare](https://github.com/cloudflare/terraform-provider-cloudflare) ([v4.42.0](https://github.com/cloudflare/terraform-provider-cloudflare/releases/tag/v4.42.0), 5 days ago) - Cloudflare Terraform Provider
- [minio/minio](https://github.com/minio/minio) ([RELEASE.2024-09-13T20-26-02Z](https://github.com/minio/minio/releases/tag/RELEASE.2024-09-13T20-26-02Z), 1 week ago) - MinIO is a high-performance, S3 compatible object store, open sourced under GNU AGPLv3 license.
- [minio/minio-go](https://github.com/minio/minio-go) ([v7.0.76](https://github.com/minio/minio-go/releases/tag/v7.0.76), 4 weeks ago) - MinIO Go client SDK for S3 compatible object storage
...
- [lucasmrdt/TheBigPromptLibrary](https://github.com/lucasmrdt/TheBigPromptLibrary) - A collection of prompts, system prompts and LLM instructions (today)
