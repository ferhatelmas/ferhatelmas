...
- [minio/minio-go](https://github.com/minio/minio-go) ([v7.0.75](https://github.com/minio/minio-go/releases/tag/v7.0.75), 2 weeks ago) - MinIO Go client SDK for S3 compatible object storage
...
- [web-fragments/web-fragments](https://github.com/web-fragments/web-fragments) - A radically different microfrontend solution that actually works and is easy to incrementally adopt. (4 days ago)
